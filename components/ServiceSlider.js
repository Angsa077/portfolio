...
export const serviceData = [
  ...
  // },
  {
    ...
    description:
      "Personal blog or a corporate site, I specialize in crafting responsive and visually appealing websites tailored to your needs.",
  },
  {
    icon: <RxReader />,
    title: "IT Consultation",
    description:
      "I want to help you make informed decisions about your IT strategies, software choices, and digital transformation initiatives.",
  },
  {
    icon: <RxRocket />,
    title: "Service HP and Laptop",
    description: "I offer services your smartphone and your laptop.",
  },
];
